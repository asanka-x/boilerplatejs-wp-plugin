...
add_action('init', 'inc_styles_scripts_init'); // For adding styles and scripts
add_action('wp_footer','init_boilerplatejs',100); // For Entry point, main.js
add_action('wp_dashboard_setup', 'boilerplatejs_dashboard_widget'); // For widget
...
// Dashboard Widget
function boilerplatejs_dashboard_widget(){
	//Creating a custom dashboard widget
	wp_add_dashboard_widget('dashboard_custom_feed','BoilerplateJS UI components','boilerplatejs_dashboard_widget_display');
}

//Dashboard widget display
function boilerplatejs_dashboard_widget_display(){
